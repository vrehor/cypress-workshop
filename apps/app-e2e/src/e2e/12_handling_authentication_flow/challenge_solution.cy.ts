...
it('Logged in user sees private board with test.email@unknown.com', () => {
  cy.login('test.email@unknown.com', 'Asdf.1234#');
...
it('Opens the private board test.email@unknown.com', () => {
  cy.login('test.email@unknown.com', 'Asdf.1234#');
...
it('Logged in user sees private board with email@unknown.com', () => {
  cy.login('email@unknown.com', 'Asdf.1234#');
