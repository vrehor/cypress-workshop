...
export class BoardDao {
  ...
  private enhancedWhere<T extends P.BoardWhereUniqueInput | P.BoardWhereInput>(where: T): T {
    return {
      ...this.currentUser?.tokenData?.user_id ? {user: {id: this.currentUser?.tokenData?.user_id}}
        : {
          user: {
            is: null
          }
  ...
  update<T extends P.BoardUpdateInput,
    Select extends P.BoardSelect = this['DEFAULT_SELECT']>(data: T, where: P.BoardWhereUniqueInput, select?: Select) {
  ...
  findAll<Select extends P.BoardSelect = this['DEFAULT_SELECT']>(select?: Select) {
    return this.find({}, select)
  }

  async delete<Select extends P.BoardSelect = this['DEFAULT_SELECT']>(boardId: string, select?: Select) {
