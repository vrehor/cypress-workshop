...
export class BoardListDao {
  ...
  private enhancedWhere<T extends P.ListWhereUniqueInput | P.ListWhereInput>(where: T): T {
    return {
  ...
  update<T extends P.ListUpdateInput,
    Select extends P.ListSelect = this['DEFAULT_SELECT']>(data: T, where: P.ListWhereUniqueInput, select?: Select) {
  ...
  async delete<Select extends P.ListSelect = this['DEFAULT_SELECT']>(listId: string, select?: Select) {
