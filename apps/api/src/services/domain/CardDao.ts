...
export class CardDao {
  ...
  private enhancedWhere<T extends P.CardWhereUniqueInput | P.CardWhereInput>(where: T): T {
    return {
  ...
  delete<Select extends P.CardSelect = this['DEFAULT_SELECT']>(where: P.CardWhereUniqueInput, select?: Select) {
  ...
  update<T extends P.CardUpdateInput,
    Select extends P.CardSelect = this['DEFAULT_SELECT']>(data: T, where: P.CardWhereUniqueInput, select?: Select) {
