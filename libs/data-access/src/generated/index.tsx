...
export type CreateBoardMutation = { __typename: 'Mutation', createBoard: { __typename: 'Board', id: string, name: string, starred: boolean } | { __typename: 'ValidationError', code: number, fields: Array<string>, messages: Array<string> } };
...
export type UpdateBoardMutation = { __typename: 'Mutation', updateBoard: { __typename: 'Board', id: string, name: string, starred: boolean } | { __typename: 'NotFoundError', code: number, message: string } };
...
export type DeleteBoardMutation = { __typename: 'Mutation', deleteBoard: { __typename: 'Board', id: string, name: string, starred: boolean } | { __typename: 'NotFoundError', code: number, message: string } };

export type BoardsQueryVariables = Exact<{ [key: string]: never; }>;


export type BoardsQuery = { __typename: 'Query', boards?: Array<{ __typename: 'Board', id: string, name: string, starred: boolean }> | null };
...
export type BoardQuery = { __typename: 'Query', board: { __typename: 'Board', id: string, name: string, starred: boolean, lists?: Array<{ __typename: 'BoardList', id: string, name: string, order: number, cards?: Array<{ __typename: 'Card', deadline?: any | null, description?: string | null, id: string, name: string, order: number, done: boolean }> | null }> | null } | { __typename: 'NotFoundError', code: number, message: string } };
...
export type CreateBoardListMutation = { __typename: 'Mutation', createBoardList: { __typename: 'BoardList', id: string, name: string, order: number, cards?: Array<{ __typename: 'Card', deadline?: any | null, description?: string | null, id: string, name: string, order: number }> | null } | { __typename: 'NotFoundError', code: number, message: string } | { __typename: 'ValidationError', code: number, fields: Array<string>, messages: Array<string> } };
...
export type UpdateBoardListMutation = { __typename: 'Mutation', updateBoardList: { __typename: 'BoardList', id: string, name: string, order: number, cards?: Array<{ __typename: 'Card', deadline?: any | null, description?: string | null, id: string, name: string, order: number }> | null } | { __typename: 'NotFoundError', code: number, message: string } };
...
export type DeleteBoardListMutation = { __typename: 'Mutation', deleteBoardList: { __typename: 'BoardList', id: string, name: string, order: number, cards?: Array<{ __typename: 'Card', deadline?: any | null, description?: string | null, id: string, name: string, order: number }> | null } | { __typename: 'NotFoundError', code: number, message: string } };
...
export type CreateCardMutation = { __typename: 'Mutation', createCard: { __typename: 'Card', description?: string | null, deadline?: any | null, id: string, name: string, order: number, done: boolean } | { __typename: 'NotFoundError', code: number, message: string } | { __typename: 'ValidationError', code: number, fields: Array<string>, messages: Array<string> } };
...
export type UpdateCardMutation = { __typename: 'Mutation', updateCard: { __typename: 'Card', description?: string | null, deadline?: any | null, id: string, name: string, order: number, done: boolean } | { __typename: 'NotFoundError', code: number, message: string } };
...
export type DeleteCardMutation = { __typename: 'Mutation', deleteCard: { __typename: 'Card', description?: string | null, deadline?: any | null, id: string, name: string, order: number, done: boolean } | { __typename: 'NotFoundError', code: number, message: string } };
...
export type UserQuery = { __typename: 'Query', user?: { __typename: 'User', id: string, email: string } | null };
...
export const UpdateBoardDocument = gql`
    mutation UpdateBoard($input: BoardUpdateInput!, $boardId: String!) {
...
export const CreateBoardListDocument = gql`
    mutation CreateBoardList($boardId: String!, $input: BoardListInput!) {
...
export const UpdateBoardListDocument = gql`
    mutation UpdateBoardList($listId: String!, $input: BoardListUpdateInput!) {
...
export const DeleteBoardListDocument = gql`
    mutation DeleteBoardList($listId: String!) {
...
export const CreateCardDocument = gql`
    mutation CreateCard($listId: String!, $input: CardInput!) {
...
export const UpdateCardDocument = gql`
    mutation UpdateCard($cardId: String!, $input: CardUpdateInput!) {
